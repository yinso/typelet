...
(function() {
  ...
  Schema = (function() {
    ...
    Schema.prototype.buildOne = function(schema) {
      ...
      if (schema["default"]) {
        return Type.baseEnv.get('property')(null, type, schema["default"]);
      } else {
        return type;
      }
    };
    ...
    Schema.prototype._typeOneOf = function(schema) {
      ...
      return Type.baseEnv.get('oneOf')(types);
    };
    ...
    Schema.prototype._array = function(schema) {
      ...
      return Type.baseEnv.get('array')(itemType);
    };
    ...
    Schema.prototype._object = function(schema) {
      ...
      props = (function() {
        ...
        for (key in ref1) {
          inner = ref1[key];
          results.push(Type.baseEnv.get('property')(key, this.buildOne(inner)));
        }
        return results;
      }).call(this);
      return Type.baseEnv.get('object')(props);
    };
