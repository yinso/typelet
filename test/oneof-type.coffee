...
describe 'One Of Type test', ->
  ...
  intOrString = Type.makeOneOfType Type.Integer, Type.String
  ...
  it 'can assign from', ->
    ...
    intOrNull = Type.makeOneOfType(Type.Integer, Type.Null)
    assert.ok intOrNull.canAssignFrom Type.makeOneOfType(Type.Null, Type.Integer) # order of the oneOfType doesn't matter.
